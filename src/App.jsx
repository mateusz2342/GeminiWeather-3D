...
export default function App() {
  ...
  const handleChatSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      // Precyzyjne wykrywanie godziny (np. 18:00, 18, o 18, 18.00)
      let targetHour = null;
      const hourMatch = q.match(/(?:o\s+)?\b([0-1]?[0-9]|2[0-3])(?::00|\.00)?\b/);
        ...
        {!loading && !error && weatherData && (
          <>
            ...
            <div className="bg-slate-900/40 p-4 rounded-2xl border border-slate-800 text-slate-300 space-y-3 mt-2">
              <h3 className="text-base font-bold text-slate-100">O aplikacja Gemini Weather 3D</h3>
