...
export default function App() {
  ...
  // Przykładowe dane i pobieranie z Open-Meteo
  const fetchWeather = async (cityName) => {
    setLoading(true);
    setError(null);
    try {
      // Najpierw pobieramy współrzędne miasta przez geocoding API
      ...
      // Pobieramy pogodę dla współrzędnych
      ...
      <main className="w-full max-w-md flex-1 flex flex-col gap-4 pb-6">
        {loading && (
          <div className="flex-1 flex flex-col items-center justify-center py-20 text-slate-400">
            ...
            <p className="text-sm">Generowanie środowiska 3D i pobieranie danych...</p>
          </div>
        )}
